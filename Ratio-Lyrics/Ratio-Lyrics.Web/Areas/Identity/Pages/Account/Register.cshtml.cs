...
namespace Ratio_Lyrics.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private RatioLyricUsers CreateUser()
        {
            try
            {
                return Activator.CreateInstance<RatioLyricUsers>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(RatioLyricUsers)}'. " +
                    $"Ensure that '{nameof(RatioLyricUsers)}' is not an abstract class and has a parameterless constructor, or alternatively " +
